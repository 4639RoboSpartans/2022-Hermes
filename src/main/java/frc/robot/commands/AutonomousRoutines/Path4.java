...
public class Path4 extends CommandBase{
    ...
    public Path4(DriveSubsystem m_drive, IntakeSubsystem m_intake, HopperSubsystem m_hopper, FeederSubsystem m_feeder, TurretSubsystem m_turret, LimeLightSubsystem m_LL, ShooterSubsystem m_shooter){
