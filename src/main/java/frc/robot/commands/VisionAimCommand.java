...
public class VisionAimCommand extends CommandBase {
    ...
    SimpleMotorFeedforward FFVTurret = new SimpleMotorFeedforward(0,0, 0);
    SimpleMotorFeedforward FFETurret = new SimpleMotorFeedforward(0,0, 0);
    SimpleMotorFeedforward FFVShroud = new SimpleMotorFeedforward(0,0, 0);
